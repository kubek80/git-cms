        ...
        {showSaveNotification && (
          <div className="p-3 bg-blue-50 border-t border-blue-200">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-blue-800">Content saved successfully!</h3>
                <div className="mt-1 text-sm text-blue-700">
                  Due to GitHub API caching, changes may take up to 2 minutes to be reflected in the UI.
                </div>
              </div>
            </div>
          </div>
